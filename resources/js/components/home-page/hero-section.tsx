...
export default function HeroSection() {
    return (
        <div className="flex min-h-[500px] flex-col items-center justify-center bg-gradient-to-br from-primary to-white">
            <TypographyH1 className="text-background">Find Your Glow.</TypographyH1>
            <TypographyP className="text-background">Buy from us and get free and cheap offers.</TypographyP>
